...
class OneOfExactlyConstraintValidatorTest {
    ...
    @Test
    void multipleFields() {
        assertThat(validator.validate(new Entity("1", "2", null, null)))
    ...
    void noFields() {
        String expected =
                "Exactly one of the following properties should be set: [alpha, one, two]. Found 0 properties set: [].";
